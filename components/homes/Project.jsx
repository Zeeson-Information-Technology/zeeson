    ...
    <div className="max-w-[80%] mx-auto my-[5rem]">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        ...
        <div className="relative w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1rem)]">
          <Image src={P1} alt="Project 1" layout="responsive" width={700} height={500} />
          <Overlay
            ...
            button={<a href="https://www.diboruwa.com" target="_blank"  rel="noopener noreferrer"  className="text-link">View project</a>}
          />
        </div>
        {/* Project 2 */}
        <div className="relative w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1rem)]">
          <Image src={P2} alt="Project 2" layout="responsive" width={700} height={500} />
          <Overlay
            ...
            button={<a href="https://www.workmateteam.com"  target="_blank"  rel="noopener noreferrer" className="text-link">View Project</a>}
          />
        </div>
        {/* Project 3 */}
        <div className="relative w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1rem)]">
          <Image src={P3} alt="Project 3" layout="responsive" width={700} height={500} />
          <Overlay
            ...
            button={<a href="https://www.tractivengine.com" target="_blank"  rel="noopener noreferrer"  className="text-link">View project</a>}
          />
        </div>
      </div>
    </div>
